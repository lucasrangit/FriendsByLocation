...
def get_user_from_cookie(cookies, app_id, app_secret):
    ...
    try:
        ...
        return None
    # getting HTTP Error 400: Bad Request back from urllib2 and
    # when accessing the graph url "This authorization code has expired."
    # OAuthException
    except:
        print >>sys.stderr, "Unandled exception"
        raise
        #return None
...
def get_access_token_from_code(code, redirect_uri, app_id, app_secret):
    ...
    #print >>sys.stderr, redirect_uri, args
    host = "https://graph.facebook.com/oauth/access_token?" + urllib.urlencode(args)
